...
<body>
    <h1>您的訂單</h1>
    <p><?php echo $UserName ?> 您好，以下是您的訂單內容，您的訂單共有 <?php echo Count_Cart_Items() ?> 項物件</p>
    <hr>
    <p><a href='index.php'>回上頁</a></p>
    <form name="login" method="post" action="send_order.php">
        ...
        收件人姓名: <input type="text" name="name" size="15" value=<?php echo $UserName ?>><br />
        電話: <input type="text" name="telphone" size="15" /><br />
        電子郵件: <input type="text" name="email" size="50" /><br />
        地址：<input type="text" name="address" size="100" /><br />
